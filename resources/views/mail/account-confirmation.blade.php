...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #fff;">
    ...
    <![endif]-->
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
            Hello {{ $account->name }}, This is you account confirmation.
        </div>
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; padding: 40px;">
                ...
                <tr>
                    <td style="background-color: #ffffff;">
                        <img src="{{$message->embed(asset('assets/images/confirmation-header.jpg'))}}" width="700" height="" alt="alt_text" border="0" style="width: 100%; height: auto; display: block; object-fit: contain;" class="g-img">
                    </td>
                </tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px;text-align: left;">
                                            <tr>
                                                <td valign="top" style="">
                                                    ...
                                                    <br/>
                                                    <p class="text--black">
                                                        Activate your account to proceed with login. click the button below to confirm your account.
                                                    </p>
                                                    ...
                                                    <center>
                                                        <a href="{{ url('confirm/account/'.base64_encode($account->id)) }}" style="border:none;background:#01affd; font-size: 1rem !important; color:#fff;padding: 15px 20px; border-radius:5px;">Account Confirmation</a>
                                                    </center>
                                                </td>
                                            </tr>
                                        </table>
