...
<div class="col-lg-8">
        ...
        <div class="panel-body container-fluid">
            ...
            <form action="" class="checkout-payment-form row" method="POST">
                ...
                @php
                    ...
                    $payment_charge = (array_sum($total_amount) + $shipping_fee) * 0.06;
                @endphp
    ...
    <button type="button" id="proceedCheckoutPayment" class="btn btn-info float-right btn-animate btn-animate-side btn-place-order wt__disable_on_submit_no_form_change">
        <span>
