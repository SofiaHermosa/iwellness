...
<div class="block w-full pt-20" id="bannerSection">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-14">
        <div class="text-center font-sans col-span-1">
            <div data-aos="zoom-in" data-aos-duration="1000" class="h-96 md:h-screen px-32 inline-block">
                <h1 class="text-2xl md:text-6xl font-extrabold text-gray-900 tracking-widest mt-44">EXPERIENCE</h1>
                <h1 class="text-xl md:text-4xl font-extrabold text-gray-900 tracking-widest bg-transparent">THE<span class="text-yellow-600">DIFFERENCE</span></h1>
                <br>
