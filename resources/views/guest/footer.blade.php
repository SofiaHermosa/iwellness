    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-1 md:gap-6">
        <div class="hidden md:block">
            <a href="#bannerSection" class="nav--link">
                <img src="{{asset('assets/images/logo-dti-approved-white.png')}}" class="w-48 sm:m-auto float-none sm:float-left relative top-1/4 transform -translate-y-1/4" alt=""> 
            </a>
        </div>

        <div class="block md:hidden">
            <a href="#bannerSection" class="nav--link">
                <img src="{{asset('assets/images/logo-dti-approved-white.png')}}" class="w-32 md:w-48 m-auto md:m-0 float-none sm:float-left relative top-1/4 transform -translate-y-1/4" alt=""> 
            </a>
        </div>

        <div class="order-2 md:order-1">
            <div class="text-center p-2 flex flex-col space-y-0 md:space-y-2 w-full md:w-32 m-auto">
