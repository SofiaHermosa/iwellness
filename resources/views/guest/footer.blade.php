<div class="block bg-yellow-400 py-14 px-4 md:px-32">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div class="col-span-2 block md:hidden">
            <a href="#bannerSection" class="nav--link">
                <img data-aos="fade-up" data-aos-duration="700" src="{{asset('assets/images/logo-dti-approved-white.png')}}" class="w-32 md:w-48 m-auto md:m-0 float-none sm:float-left relative top-1/2 transform -translate-y-1/2" alt=""> 
            </a>
        </div>
        ...
        <div>
            <div data-aos="fade-up" data-aos-duration="1000" class="text-center p-2 flex flex-col space-y-0 md:space-y-2 w-full md:w-32 m-auto">
                ...
                <a href="{{url('register')}}" class="text-gray-700 hover:bg-white hover:text-gray-800 block px-3 py-2 rounded-md text-base font-semibold">Sign In</a>
            </div>
        </div>
